...
//后台安全设置
$ecms_config['esafe']['loginauth']='000000';	//登录认证码,如果设置登录需要输入此认证码才能通过
$ecms_config['esafe']['enloginauth']=0;	//登录认证码加密验证串有效时间,单位:秒(0为不启用加密)
$ecms_config['esafe']['ecookiernd']='8ZrIJCdtKJoQ2o5C2PcqQwtG3npGp0rhBZ6i';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='tqlok';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='coftf';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='Rl2dnRaQ00T3VASXopKVsRzB9gHMiYFjXVA';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='Qf2ZCpI1QY9QM18mqCWNPUZpVy5K5dL5Am';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='oNAuYj9cXcMnwMtBc6GI5Xs1kb3RDTHQC';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='MvTd2BECpXUi37oM24YkV4dxXKe5MMMJ';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='I7tzS0tjEZ6kjjIRQudkaG4i3knVZPc';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'8MdEnIOd6ExIOFP3KRApse3WbtCQv2Qh',
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'bRhTlAZMqj9GxyxyPG2KipfTR1jH8NBOljF6',
'mhavedatedo'=>0,
'reportkey'=>0,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'1sEc30ZOV8L32X52BAmH1PSGV701xkZUp16aeVBN6r',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>0,
