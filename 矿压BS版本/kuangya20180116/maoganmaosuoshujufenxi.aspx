<%@ Page Language="C#" AutoEventWireup="true" CodeFile="maoganmaosuoshujufenxi.aspx.cs" Inherits="maoganmaosuoshujufenxi" %>
...
<body>
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 锚杆/索应力管理 <span class="c-gray en">&gt;</span> 锚杆/索数据分析 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">
        ...
        <asp:UpdatePanel runat ="server" ID ="UpdatePanel1" style="display:inline-block" >  
            ...
            锚固类型：<asp:DropDownList ID="ddl_maoguleixing" runat="server" OnSelectedIndexChanged ="ddl_roadway_changed" AutoPostBack ="true" CssClass="select" Width="120" Height="30">
            ...
            <asp:LinkButton ID="search" runat="server" CssClass="btn btn-success radius" OnClientClick="return check();" OnClick="search_Click"> 查询</asp:LinkButton>
            <asp:LinkButton ID="lbtn_export" runat="server" CssClass="btn btn-success radius" OnClick="lbtn_export_Click"> 导出图片</asp:LinkButton>
...
<script type="text/javascript">
    ...
    function check() {
        ...
        if ($("#ddl_roadway").val() == "0") {
            alert("请选择巷道");
            return false;
        }
        if ($("#ddl_anzhuangweizhi").val() == "0") {
            alert("请选择安装位置");
            return false;
        }
    }
