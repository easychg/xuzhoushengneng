...
public partial class anquanfakaiqiquxian : System.Web.UI.Page
{
    ...
    protected void ddl_gongzuomian_changed(object sender, EventArgs e)
    {
        ...
        string sql = "select BracketNo from PreSenInfo where areaName='" + cequ + "' and FaceName='" + gongzuomian + "'";
        DataSet ds = DB.ExecuteSqlDataSet(sql, null);
        if (ds.Tables[0].Rows.Count > 0)
        {
            ddl_zhijiabianhao.Items.Clear();
    ...
    protected void lbtn_export_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=安全阀开启分析曲线.jpg");
