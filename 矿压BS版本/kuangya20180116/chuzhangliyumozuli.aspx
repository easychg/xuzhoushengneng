<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chuzhangliyumozuli.aspx.cs" Inherits="chuzhangliyumozuli" %>
...
<body>
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 综采压力管理 <span class="c-gray en">&gt;</span> 初掌力与末阻力 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
        ...
        <asp:UpdatePanel runat ="server" ID ="UpdatePanel1" style="display:inline-block" >  
            ...
            <div class="radio-box">
              ...
              <asp:LinkButton ID="search" runat="server" 
                ...
                <asp:LinkButton ID="lbtn_excel" runat="server" 
                CssClass="btn btn-success radius" 
                onclick="lbtn_excel_Click" > 导出Excel</asp:LinkButton>
            </div>
