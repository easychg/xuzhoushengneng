<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dingbanlicengshujuchaxun.aspx.cs" Inherits="dingbanlicengshujuchaxun" %>
                    ...
                    <asp:Repeater ID="rptlist" runat="server">
                        <ItemTemplate>
                            <tr class="text-c">
                                ...
                                <td><%#Eval("sensorno")%></td>
                                <td><%#Eval("location")%></td>
                                <td><%#Eval("pointdeptha")%></td>
                                <td><%#Eval("pointdepthb")%></td>
                                <td><%#Eval("displacement1")%></td>
                                <td><%#Eval("displacement2")%></td>
                                <td><%#Eval("abswy")%></td>
                                <td><%#Eval("alarmh")%></td>
                            </tr>
                        </ItemTemplate>
