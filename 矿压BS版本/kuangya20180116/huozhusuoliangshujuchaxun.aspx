<%@ Page Language="C#" AutoEventWireup="true" CodeFile="huozhusuoliangshujuchaxun.aspx.cs" Inherits="huozhusuoliangshujuchaxun" %>
...
<body>
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 活柱缩量管理 <span class="c-gray en">&gt;</span> 活柱缩量数据查询 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">
        ...
        <asp:UpdatePanel runat ="server" ID ="UpdatePanel1" style="display:inline-block" >  
            ...
            支架编号：<asp:DropDownList ID="ddl_anzhuangweizhi" runat="server" CssClass="select" Height="30" Width="160">
            <asp:ListItem Text="--请选择--" Value="0"></asp:ListItem>
            </asp:DropDownList>
                    ...
                    <asp:Repeater ID="rptlist" runat="server">
                        <ItemTemplate>
                            <tr class="text-c">
                                ...
                                <td><%#Eval("time")%></td>
                                <td><%#Eval("sensorno")%></td>
                                <td><%#Eval("bracketno")%></td>
                                <td><%#Eval("huozhu1")%></td>
                                <td><%#Eval("alarmstate")%></td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                </tbody>
