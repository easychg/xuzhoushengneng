<%@ Page Language="C#" AutoEventWireup="true" CodeFile="weiyanyinglishujuchaxun.aspx.cs" Inherits="weiyanyinglishujuchaxun" %>
...
<body>
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 围岩应力管理 <span class="c-gray en">&gt;</span> 围岩应力数据查询 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">
        ...
        <asp:UpdatePanel runat ="server" ID ="UpdatePanel1" style="display:inline-block" >  
            ...
            位置：<asp:DropDownList ID="ddl_anzhuangweizhi" runat="server" CssClass="select" Height="30" Width="160">
            <asp:ListItem Text="--请选择--" Value="0"></asp:ListItem>
            </asp:DropDownList>
