...
<body>
    ...
    <div class="page-container">
        <div class="text-c">
            ...
            <asp:LinkButton ID="search" runat="server" CssClass="btn btn-success radius" OnClick="search_Click"> 搜管理员组</asp:LinkButton>
        </div>
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="admin_role_edit('添加用户','guanliyuanzu.aspx','510')" class="btn btn-primary radius"> 添加管理员组</a></span></div>
        <div class="mt-20">
