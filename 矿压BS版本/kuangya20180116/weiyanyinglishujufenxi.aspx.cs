...
public partial class weiyanyinglishujufenxi : System.Web.UI.Page
{
    ...
    protected void search_Click(object sender, EventArgs e)
    {
        ...
        Bitmap img = DrawImage.DrawingCurve.DrawingImg24(cequ, roadway, anzhuangweizhi, time1, time2, a);
        string str = Server.MapPath("./xiazai/");
        img.Save(str + "weiyanyinglishujufenxi.jpg");
        panel1.BackImageUrl = "xiazai/weiyanyinglishujufenxi.jpg";
    ...
    protected void lbtn_export_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=围岩应力数据分析.jpg");
    ...
    protected void ddl_cequ_changed(object sender, EventArgs e)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            sql = "SELECT Location FROM DrillSenInfo1 where areaName='" + ddl_cequ.SelectedValue + "' and roadwayName='" + ds.Tables[0].Rows[0]["roadName"].ToString() + "' order by Location";
    ...
    {
        string sql = "SELECT Location FROM DrillSenInfo1 where areaName='" + ddl_cequ.SelectedValue + "' and roadwayName='" + ddl_roadway.SelectedValue + "' order by Location";
        DataSet ds = DB.ExecuteSqlDataSet(sql, null);
        if (ds.Tables[0].Rows.Count > 0)
        {
            ddl_anzhuangweizhi.Items.Clear();
