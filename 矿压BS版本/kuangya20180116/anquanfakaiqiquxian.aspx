<%@ Page Language="C#" AutoEventWireup="true" CodeFile="anquanfakaiqiquxian.aspx.cs" Inherits="anquanfakaiqiquxian" %>
...
<body>
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 综采压力管理 <span class="c-gray en">&gt;</span> 安全阀开启分析曲线 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">
        ...
        <asp:UpdatePanel runat ="server" ID ="UpdatePanel1" style="display:inline-block" >  
            ...
            <%--<div class="radio-box">
              ...
              <div class="radio-box">
                <input type="radio" id="zuozhu"  runat="server" value="1" name="r1" checked />
