<%@ Page Language="C#" AutoEventWireup="true" CodeFile="huozhusuoliangshujufenxi.aspx.cs" Inherits="huozhusuoliangshujufenxi" %>
...
<body>
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 活柱缩量管理 <span class="c-gray en">&gt;</span> 活柱缩量数据分析 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">
        ...
        <asp:UpdatePanel runat ="server" ID ="UpdatePanel1" style="display:inline-block" >  
            ...
            选择工作面：<asp:DropDownList ID="ddl_roadway" runat="server" OnSelectedIndexChanged ="ddl_roadway_changed" AutoPostBack ="true" CssClass="select" Height="30" Width="160">
