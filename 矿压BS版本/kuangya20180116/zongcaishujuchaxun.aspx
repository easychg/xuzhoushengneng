<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zongcaishujuchaxun.aspx.cs" Inherits="zongcaishujuchaxun" %>
...
<body>
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 综采压力管理 <span class="c-gray en">&gt;</span> 综采数据分析 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
            ...
            <table class="table table-border table-bordered table-hover table-bg table-sort">
                <thead>
                    <tr class="text-c">
                        ...
                        <th>传感器编号</th>
                        <th>支架号</th>
                        <th><asp:Label ID="lbl_p1" runat="server" Text="前柱"></asp:Label> </th>
                        <th><asp:Label ID="lbl_p2" runat="server" Text="后柱"></asp:Label></th>
                        <th>报警状态</th>
                    </tr>
                </thead>
                <tbody>
                    <asp:Repeater ID="rptlist" runat="server" OnItemCommand="rptlist_ItemCommand">
                        <ItemTemplate>
                            <tr class="text-c">
                                ...
                                <td><%#Eval("sensorNo")%></td>
                                <td><%#Eval("Pressure1")%></td>
                                <td><%#Eval("Pressure2")%></td>
                                <td><%#Eval("AlarmH")%></td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
