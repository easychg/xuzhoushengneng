<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xunjiayuan_list.aspx.cs" Inherits="xunjiayuan_list" %>
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 条件管理（插入） <span class="c-gray en">&gt;</span> 询价员列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
<form id="Form1" runat="server">
  <div class="text-c"> 询价员：
    <input type="text" class="input-text" style="width:250px" placeholder="输入询价员" id="inshiyongdanwei" runat="server" />
  ...
  <table class="table table-border table-bordered table-hover table-bg table-sort">
    ...
    <ItemTemplate>
     <tr class="text-c">
        <td><asp:CheckBox runat="server" ID="ckb" ToolTip='<%#Eval("xunjiayuan_id") %>' /></td>
