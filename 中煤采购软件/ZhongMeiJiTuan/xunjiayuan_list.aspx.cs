...
public partial class xunjiayuan_list : System.Web.UI.Page
{
    ...
    {
        string sql = "select * from xunjiayuan where " + ViewState["search"] + " order by addtime desc";
    ...
    protected void lbtn_save_Click(object sender, EventArgs e)
    {
        ...
        string sql = "select count(xunjiayuan_id) from xunjiayuan where mingcheng='" + sydw + "'";
        ...
        if (result != "" && result != "no")
        {
            ...
            {
                //未查询
                sql = "insert into xunjiayuan(mingcheng) values('" + sydw + "')";
    ...
    protected void lbtn_dels_Click(object sender, EventArgs e)
    {
        ...
        string sql = "delete from xunjiayuan where xunjiayuan_id in(" + ids + ")";
