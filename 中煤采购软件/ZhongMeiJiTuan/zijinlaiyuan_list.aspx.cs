...
public partial class zijinlaiyuan_list : System.Web.UI.Page
{
    ...
    {
        string sql = "select * from zijinlaiyuan where " + ViewState["search"] + " order by addtime desc";
    ...
    protected void lbtn_save_Click(object sender, EventArgs e)
    {
        ...
        string sql = "select count(zijinlaiyuan_id) from zijinlaiyuan where mingcheng='" + sydw + "'";
        ...
        if (result != "" && result != "no")
        {
            ...
            {
                //未查询
                sql = "insert into zijinlaiyuan(mingcheng) values('" + sydw + "')";
    ...
    protected void lbtn_dels_Click(object sender, EventArgs e)
    {
        ...
        string sql = "delete from zijinlaiyuan where zijinlaiyuan_id in(" + ids + ")";
    ...
    protected void lbtn_cancel_Click(object sender, EventArgs e)
    {
        ...
        string sql = "update zijinlaiyuan set isxianzhi=0 where zijinlaiyuan_id in(" + ids + ")";
        int result = DB.ExecuteSql(sql, null);
        if (result > 0)
        {
            BindInfo();
    ...
    protected void lbtn_add_Click(object sender, EventArgs e)
    {
        ...
        string sql = "update zijinlaiyuan set isxianzhi=1 where zijinlaiyuan_id in(" + ids + ")";
        int result = DB.ExecuteSql(sql, null);
        if (result > 0)
        {
            BindInfo();
