...
public partial class jihualeixing_list : System.Web.UI.Page
{
    ...
    {
        string sql = "select * from jihualeixing where " + ViewState["search"] + " order by addtime desc";
    ...
    protected void lbtn_save_Click(object sender, EventArgs e)
    {
        ...
        string sql = "select count(jihualeixing_id) from jihualeixing where mingcheng='" + sydw + "'";
        ...
        if (result != "" && result != "no")
        {
            ...
            {
                //未查询
                sql = "insert into jihualeixing(mingcheng) values('" + sydw + "')";
    ...
    protected void lbtn_dels_Click(object sender, EventArgs e)
    {
        ...
        string sql = "delete from jihualeixing where jihualeixing_id in(" + ids + ")";
    ...
    protected void lbtn_cancel_Click(object sender, EventArgs e)
    {
        ...
        string sql = "update jihualeixing set isxianzhi=0 where jihualeixing_id in(" + ids + ")";
        int result = DB.ExecuteSql(sql, null);
        if (result > 0)
        {
            BindInfo();
    ...
    protected void lbtn_add_Click(object sender, EventArgs e)
    {
        ...
        string sql = "update jihualeixing set isxianzhi=1 where jihualeixing_id in(" + ids + ")";
        int result = DB.ExecuteSql(sql, null);
        if (result > 0)
        {
            BindInfo();
