<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chaxun_list.aspx.cs" Inherits="chaxun_list" %>
...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 物资采购数据管理 <span class="c-gray en">&gt;</span> 查询列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c"> 
		<input type="text" onfocus="WdatePicker({ maxDate:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}' })" id="datemin" class="input-text Wdate" style="width:120px;display:none;" runat="server" />
		
		<input type="text" onfocus="WdatePicker({ minDate:'#F{$dp.$D(\'datemin\')}',maxDate:'%y-%M-%d' })" id="datemax" class="input-text Wdate" style="width:120px;display:none;" runat="server" />
        <asp:DropDownList ID="ddl_state" runat="server" CssClass="select" Width="200" Height="30" Visible="false">
    ...
    <span class="l">
    <asp:LinkButton ID="lbtn_daohuo" runat="server" CssClass="btn btn-danger radius" OnClientClick="return check()" Text="标记到货" onclick="lbtn_daohuo_Click" Visible="false"></asp:LinkButton>
        <asp:LinkButton ID="lbtn_delete" runat="server" CssClass="btn btn-danger radius" OnClientClick="return check()" Text="删除" onclick="lbtn_delete_Click" Visible="false"></asp:LinkButton>
    </span> 
