...
public partial class dingjiafangshi_list : System.Web.UI.Page
{
    ...
    {
        string sql = "select * from dingjiafangshi where " + ViewState["search"] + " order by addtime desc";
    ...
    protected void lbtn_save_Click(object sender, EventArgs e)
    {
        ...
        string sql = "select count(dingjiafangshi_id) from dingjiafangshi where mingcheng='" + sydw + "'";
        ...
        if (result != "" && result != "no")
        {
            ...
            {
                //未查询
                sql = "insert into dingjiafangshi(mingcheng) values('" + sydw + "')";
    ...
    protected void lbtn_dels_Click(object sender, EventArgs e)
    {
        ...
        string sql = "delete from dingjiafangshi where dingjiafangshi_id in(" + ids + ")";
