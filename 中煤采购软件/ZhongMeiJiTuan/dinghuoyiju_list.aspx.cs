...
public partial class dinghuoyiju_list : System.Web.UI.Page
{
    ...
    {
        string sql = "select * from dinghuoyiju where " + ViewState["search"] + " order by addtime desc";
    ...
    protected void lbtn_save_Click(object sender, EventArgs e)
    {
        ...
        string sql = "select count(dinghuoyiju_id) from dinghuoyiju where mingcheng='" + sydw + "'";
        ...
        if (result != "" && result != "no")
        {
            ...
            {
                //未查询
                sql = "insert into dinghuoyiju(mingcheng) values('" + sydw + "')";
    ...
    protected void lbtn_dels_Click(object sender, EventArgs e)
    {
        ...
        string sql = "delete from dinghuoyiju where dinghuoyiju_id in(" + ids + ")";
