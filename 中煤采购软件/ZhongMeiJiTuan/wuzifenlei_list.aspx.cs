...
public partial class wuzifenlei_list : System.Web.UI.Page
{
    ...
    {
        string sql = "select * from wuzifenlei where " + ViewState["search"] + " order by addtime desc";
    ...
    protected void lbtn_save_Click(object sender, EventArgs e)
    {
        ...
        if (sydw == "")
        {
            SystemTool.AlertShow(this, "请输入物资分类");
            return;
        }
        string sql = "select count(wuzifenlei_id) from wuzifenlei where mingcheng='" + sydw + "'";
        ...
        if (result != "" && result != "no")
        {
            ...
            {
                //未查询
                sql = "insert into wuzifenlei(mingcheng) values('" + sydw + "')";
    ...
    protected void lbtn_dels_Click(object sender, EventArgs e)
    {
        ...
        string sql = "delete from wuzifenlei where wuzifenlei_id in(" + ids + ")";
