...
<body>
    ...
    <div class="page-container">
        <div class="text-c">
            ...
            <asp:LinkButton ID="search" runat="server" CssClass="btn btn-success radius" OnClick="search_Click"><i class="Hui-iconfont">&#xe665;</i> 搜管理员</asp:LinkButton>
        </div>
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="admin_role_edit('添加用户','guanliyuan.aspx','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span></div>
        <div class="mt-20">
