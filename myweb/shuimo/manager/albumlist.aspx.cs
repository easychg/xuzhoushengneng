...
public partial class manager_albumlist : System.Web.UI.Page
{
    ...
    {
        string sql = "select a.id,a.title,a.article_image,a.author,a.descr,a.visited,a.addtime,a.isshow,a.istuijian,n.nav_name from article_info a left join nav_info n on n.id=a.nav_id where detail='album' and " + ViewState["search"] + "order by a.addtime desc";
