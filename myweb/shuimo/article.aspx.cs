...
public partial class article : System.Web.UI.Page
{
    ...
    private void BindInfo()
    {
        ...
        sql = "select max(id) from article_info where id<" + id + " and isshow=1 and detail !='album'";
        ...
        sql = "select min(id) from article_info where id>" + id + " and isshow=1 and detail !='album'";
