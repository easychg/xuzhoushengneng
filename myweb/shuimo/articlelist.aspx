            ...
            <ItemTemplate>
                 <li>
                  <div class="dttext f_l">
                    <ul>
                      <h2><a href='<%#Eval("muban_url") %>?id=<%#Eval("id") %>'><%#Eval("title") %></a></h2>
                      <p><%#Eval("descr") %>.</p>
                      <span><%#Eval("addtime") %></span>
                    </ul>
                  </div>
                  <div class="xwpic f_r"><a href='<%#Eval("muban_url") %>?id=<%#Eval("id") %>'><img src='<%#Eval("article_image").ToString().Split('#')[0] %>'></a></div>
                </li>
            </ItemTemplate>
        </asp:Repeater>
      </div>
