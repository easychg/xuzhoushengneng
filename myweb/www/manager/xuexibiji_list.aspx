<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xuexibiji_list.aspx.cs" Inherits="manager_xuexibiji_list" %>
...
<body>
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 我的日记 <span class="c-gray en">&gt;</span> 学习笔记列表 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="xuexibiji_add.aspx" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加文章</a></span></div>
        <div class="mt-20">
...
<%--                                    <asp:LinkButton ID="lbtn_open" runat="server" Text="启用" CommandName="lbtn_open" CommandArgument='<%#Eval("id") %>' Style="color: #fff" CssClass="btn btn-success radius"></asp:LinkButton>
                                    ...
                                    <a href='xuexibiji_add.aspx?id=<%#Eval("id") %>' class="btn btn-warning radius">详细</a>
                               </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
