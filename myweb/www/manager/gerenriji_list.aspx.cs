...
public partial class manager_gerenriji_list : System.Web.UI.Page
{
    ...
    {
        string sql = "select a.id,a.title,a.article_image,a.author,a.descr,a.visited,a.addtime,a.isshow,n.nav_name from article_info a left join nav_info n on n.id=a.nav_id where nav_id=7 and " + ViewState["search"] + "order by a.addtime desc";
