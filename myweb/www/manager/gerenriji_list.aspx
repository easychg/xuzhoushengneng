<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gerenriji_list.aspx.cs" Inherits="manager_gerenriji_list" %>
...
<body>
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 我的日记 <span class="c-gray en">&gt;</span> 个人日记列表 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">
        <div class="text-c">
            ...
            <input type="text" class="input-text" style="width: 250px" placeholder="输入文章标题" id="qitatiaojian" runat="server" name=""/>
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="gerenriji_add.aspx" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加文章</a></span></div>
        <div class="mt-20">
                    ...
                    <asp:Repeater ID="rptlist" runat="server" OnItemCommand="rptlist_ItemCommand" >
                        <ItemTemplate>
                            <tr class="text-c">
                                ...
                                <td><%#Eval("nav_name") %></td>
                                <td><%#Eval("title") %></td>
                                <td><asp:Label ID="lbl_image" runat="server" Text='<%#Eval("article_image") %>'></asp:Label></td>
                                <td><%#Eval("author") %></td>
                                <td><%#SystemTool.CutString( Eval("descr").ToString(),50,0)+"..." %></td>
                                <td><%#Eval("visited") %></td>
...
<%--                                    <asp:LinkButton ID="lbtn_open" runat="server" Text="启用" CommandName="lbtn_open" CommandArgument='<%#Eval("id") %>' Style="color: #fff" CssClass="btn btn-success radius"></asp:LinkButton>
                                    ...
                                    <a href='gerenriji_add.aspx?id=<%#Eval("id") %>' class="btn btn-warning radius">详细</a>
                               </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
