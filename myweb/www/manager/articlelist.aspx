<%@ Page Language="C#" AutoEventWireup="true" CodeFile="articlelist.aspx.cs" Inherits="manager_articlelist" %>
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="articleadd.aspx" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加文章</a></span></div>
        <div class="mt-20">
...
<%--                                    <asp:LinkButton ID="lbtn_open" runat="server" Text="启用" CommandName="lbtn_open" CommandArgument='<%#Eval("id") %>' Style="color: #fff" CssClass="btn btn-success radius"></asp:LinkButton>
                                    ...
                                    <a href='articleadd.aspx?id=<%#Eval("id") %>' class="btn btn-warning radius">详细</a>
                               </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
