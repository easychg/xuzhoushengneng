...
<body>
    <div class="pd-20">
        <form runat="server" id="forma">
            <div class="row cl">
                <label class="form-label col-2" style="text-align:right"><span class="c-red">*</span>组名称：</label>
            ...
            <div class="row cl"  style="margin-top:5px">
                <label class="form-label col-2" style="text-align:right">组权限值：</label>
                <div class="formControls col-8">
            ...
            <div class="row cl"  style="margin-top:5px">
                <label class="form-label col-2" style="text-align:right">排序：</label>
                <div class="formControls col-8">
            ...
            <div class="row cl"  style="margin-top:5px">
                <label class="form-label col-2" style="text-align:right">组状态：</label>
                <div class="formControls col-8">
            ...
            <div class="row cl" style="margin-top:5px">
                <label class="form-label col-2" style="text-align:right">组描述：</label>
                <div class="formControls col-8">
            ...
            <div class="row cl" style="margin-top:5px">
                <label class="form-label col-2" style="text-align:right"><span class="c-red">*</span>组权限：</label>
                <div class="formControls col-8" style="border:1px solid #d2d2d2;">
